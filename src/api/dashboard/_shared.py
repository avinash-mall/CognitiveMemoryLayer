...
_EDITABLE_SETTINGS = frozenset(
    {
        ...
        "llm_eval.model",
        "llm_eval.base_url",
        "summarizer_internal.provider",
        "summarizer_internal.model",
        "summarizer_internal.task",
        "summarizer_internal.max_input_chars",
        "summarizer_internal.max_output_chars",
        "summarizer_internal.min_length",
        "summarizer_internal.max_length",
        "summarizer_internal.device",
...
_CONFIG_KEY_TO_ENV: dict[str, str] = {
    ...
    "embedding_internal.device": "EMBEDDING_INTERNAL__DEVICE",
    ...
    "summarizer_internal.provider": "SUMMARIZER_INTERNAL__PROVIDER",
    "summarizer_internal.model": "SUMMARIZER_INTERNAL__MODEL",
    "summarizer_internal.task": "SUMMARIZER_INTERNAL__TASK",
    "summarizer_internal.max_input_chars": "SUMMARIZER_INTERNAL__MAX_INPUT_CHARS",
    "summarizer_internal.max_output_chars": "SUMMARIZER_INTERNAL__MAX_OUTPUT_CHARS",
    "summarizer_internal.min_length": "SUMMARIZER_INTERNAL__MIN_LENGTH",
    "summarizer_internal.max_length": "SUMMARIZER_INTERNAL__MAX_LENGTH",
    "summarizer_internal.device": "SUMMARIZER_INTERNAL__DEVICE",
