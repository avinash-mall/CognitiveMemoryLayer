...
class SemanticFactModel(Base):
    ...
    __table_args__ = (
        Index("ix_semantic_facts_tenant_user_key", "tenant_id", "user_id", "key", "is_current"),
        Index("ix_semantic_facts_tenant_user_category", "tenant_id", "user_id", "category", "is_current"),
    )
