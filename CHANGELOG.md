...
- **Cognitive Constraint Layer (LoCoMo-Plus Level-2 optimisation)** — Full implementation of latent constraint extraction, storage, and retrieval based on the [deep-research-report](evaluation/deep-research-report.md) analysis. Addresses issues ISS-01 through ISS-09 across 5 phases:
